...
class MyDataSet(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        """
        if self.is_train:
            return self.string2tensor(self.words[idx]),self.tense2tensor(self.tenses[idx])
        else:
            return self.string2tensor(self.words[idx][0]),self.tense2tensor(self.tenses[idx][0]),\
                   self.string2tensor(self.words[idx][1]),self.tense2tensor(self.tenses[idx][1])
